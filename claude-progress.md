...
- `CREW-000` is implemented and passing.
- The repo contains one Flow wrapping one sequential infrastructure Crew with five agents: repo state analyst, Terraform provisioning architect, Ansible configuration architect, platform lifecycle specialist, and QA contract guardian.
